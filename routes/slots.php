<?php
/**
 * Routes de gestion des créneaux.
 * PATCH /slots/:id — Modifier le type d'un créneau
 */

function handle_slots(string $route, string $method): void {
...
function slots_update(string $slotId): void {
    ...
    // Vérifier que le slot existe et que la semaine n'est pas verrouillée
    $stmt = $pdo->prepare('
